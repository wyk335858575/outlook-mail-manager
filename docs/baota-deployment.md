...
```text
ghcr.io/wyk335858575/outlook-mail-manager:1.0.4
```
...
APP_IMAGE=ghcr.io/wyk335858575/outlook-mail-manager:1.0.4
...
```bash
docker pull ghcr.io/wyk335858575/outlook-mail-manager:1.0.4
```
...
输出应包含 `ghcr.io/wyk335858575/outlook-mail-manager@sha256:...`。将完整值与 [v1.0.4 Release](https://github.com/wyk335858575/outlook-mail-manager/releases/tag/v1.0.4) 中签名的 `release-manifest.json` 比对。
...
1. 打开“Docker” > “镜像”。
2. 点击“拉取镜像”或“线上镜像”。
3. 镜像地址填写 `ghcr.io/wyk335858575/outlook-mail-manager:1.0.4`，不要添加 `https://`。
4. 仓库用户名和密码留空；当前 GHCR 包是公开镜像。
5. 等待下载完成，在本地镜像列表确认名称和 `1.0.4` 标签。
